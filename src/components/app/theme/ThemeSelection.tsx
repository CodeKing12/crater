...
export default function ThemeSelection() {
    ...
    function handleGroupAccordionChange(open: (ThemePanelGroupValues | string)[], e?: MouseEvent) {
        ...
        setThemeControls(produce(store => {
    ...
    return (
        <Flex h="full" pos="relative">
            <SelectionGroups searchInput={<ThemeSearchInput searchMode={themeControls.searchMode} updateSearchMode={updateSearchMode} query={themeControls.query} onFilter={handleFilter} />} currentGroup={[themeControls.group]} groups={appStore.displayGroups.theme} handleAccordionChange={handleGroupAccordionChange} actionMenus={<ThemeSelectionGroupDisplay />} />
