...
export default function SongSelection() {
    const [allSongs, setAllSongs] = createStore<SongData[]>([]);
    ...
    createEffect(() => {
        window.electronAPI.fetchAllSongs().then(result => {
            console.log("Songs Fetched: ", result.length);
            setAllSongs(result);
                ...
                <Box style={{
                    ...
                    <For each={rowVirtualizer().getVirtualItems()}>
                        {virtualItem => (
                            ...
                            }}>{filteredSongs[virtualItem.index].title}</Text>
                        )}
                    </For>
                </Box>
            </ControlTabDisplay>
