...
export const Header = withContext<HTMLStyledProps<'div'>>(
  "div",
  "header",
)

export const Footer = withContext<HTMLStyledProps<'div'>>(
  "div",
  "footer",
)

export const Body = withContext<HTMLStyledProps<'div'>>(
  "div",
  "body",
)
